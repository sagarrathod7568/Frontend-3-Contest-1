...
const renderEmployees = () => {
    ...
    employeeList.style.border = "thin solid white";
    employeeList.style.padding='10px';
    employeeList.style.marginRight='10px';
    employeeList.style.width='550px';
    employeeList.style.borderRadius = "5px";
    ...
    // deleteButtons.style.color='white';
